...
from app.models.models import Order, OrderItem, Payment, Size, SizeStock, ColorStock
from app.schemas.order_schemas import OrderCreate, ProductCreate, ColorCreate, PaymentCreate, SizeStockCreate, ColorStockCreate, SizeCreate
...
def create_size_stock(db: Session, size_stock_data: SizeStockCreate) -> SizeStock:
...
def create_color_stock(db: Session, color_stock_data: ColorStockCreate) -> ColorStock:
